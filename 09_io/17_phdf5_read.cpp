...
int main (int argc, char** argv) {
  ...
  printf("rank: %d, offset: (%d %d), Nlocal: (%d %d), block: (%d, %d), count: (%d %d), stride: (%d %d)\n", mpirank, offset[0], offset[1], Nlocal[0], Nlocal[1], block[0], block[1], count[0], count[1], stride[0], stride[1]);
